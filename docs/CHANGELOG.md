...
**📝 詳細なリリースノートは [RELEASE_NOTES.md](RELEASE_NOTES.md) をご覧ください。**
...
📖 **Unreleased は内部構造の改善であり、機能変更はありません**
...
- **表示フォーマット統一**: すべての予約表示を `/reserve` コマンドのフォーマットに統一
...
- **カラーコード統一**: 各コマンドに適切な色を設定（緑/黄/赤/青/グレー/紫）
